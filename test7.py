...
def load_datasets(partition_id: int):
    ...
    #pytorch_ = transforms.Compose([])
    #pytorch_transforms = transforms.Compose(
    #    [transforms.ToTensor(), transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))]
    #)

    #pytorch_transforms = transforms.Compose([v2.RandomResizedCrop(size=(224, 224), antialias=True), transforms.ToTensor(), v2.RGB(),
...
class Net(nn.Module):
    def __init__(self) -> None:
        ...
        self.conv1 = nn.Conv2d(3, 6, 2)  # misallignment of input into thisl ayer
        self.pool = nn.MaxPool2d(2, 2)
