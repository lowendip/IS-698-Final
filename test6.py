...
def load_datasets(partition_id: int):
    ...
    #)
    pytorch_transforms = transforms.Compose([transforms.Resize((1552,1880)), transforms.ToTensor()])
    ...
    dataset_dict = load_dataset("imagefolder", data_dir="./images/train/Normal")
...
class Net(nn.Module):
    def __init__(self) -> None:
        ...
        self.conv1 = nn.Conv2d(1, 32, 5) #misallignment of input into thisl ayer
        #self.conv1 = nn.Conv2d(6, 3, 5)  # misallignment of input into thisl ayer
